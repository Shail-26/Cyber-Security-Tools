    ...
    return (
            ...
            for (v = 0; v <= a.length; v += 1) {
                if (((s = a.charCodeAt(v) || 0), (t = (A * v) % f), t > 0 && o)) {
                    if (((u = Math.pow(2, f - t) - 1), 
                        ...
                        (q = (s & u) << t), (r = (o & p) >> (h - t)), B.push(q + r), v < a.length)) {
                ...
                } else if (v < a.length) for (u = Math.pow(2, f) - 1, w = 0; z > w; w += 1) (n = s & u), B.push(n >> (w * f)), (u <<= f);
                o = s;
            }
        ...
        (a.prototype.decode = function (a, c) {
            ...
            var l,
                ...
                o = n.data,
                p = [];
            if (1 === f) for (l = 3, m = !1; !m && l < o.length && !m; l += 4) (m = i(o, l, f)), m || p.push(o[l] - (255 - h + 1));
            var q = "",
                r = 0,
                s = 0,
                t = Math.pow(2, g) - 1;
